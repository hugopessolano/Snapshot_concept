...
If you access the provided address and specified port through your web browser, you should get something like this:
...
Once you've completed the arguments, just click on the "Execute" button which should be fairly visible:
...
On our "Server" side, our console will register what it's doing with a neat little progress bar:
...
* Next it will fetch the products from our API reusing the same structure from the **snapshot** endpoint
...
Feel free to branch and alter this as much as you like =)
